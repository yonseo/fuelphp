            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                    ...
                    <a href="/posts/edit/<?php echo $post->id; ?>" style="float: right"><button><i class="fa fa-pencil fa-lg" aria-hidden="true"></i></button></a>
                    <a href="/posts/delete/<?php echo $post->id; ?>" style="float: right"><button><i class="fa fa-trash fa-lg" aria-hidden="true"></i></button></a>
                </td>
              </tr>
                <?php endforeach; ?>
            </tbody>
